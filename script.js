...
const startl = setInterval(start, 25000);



function clickMyButton2() {
  document.getElementById("nxtBtn").click();
}

// Set the interval to call the function every 1000ms (1 second)
const clickInterval2 = setInterval(clickMyButton2, 5000);
